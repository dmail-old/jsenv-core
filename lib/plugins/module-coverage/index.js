...
var jsenvOptions = jsenv.getOptions('module-coverage');
...
if (options.urlIsPartOfCoverage) {
    coverage.install(options);
    jsenv.run('module-coverage', function() {
        var collector = coverage.collect(coverage.value);

...
import sourceMaps from 'jsenv/plugin/module-source-map';
import exceptionHandler from 'jsenv/plugin/exception-handler';
...
// tu le crée mais tu fais rien avec
jsenv.provide(function improveSyntaxError() {

...
const Template = CompilableNode.extend({
    name: 'template',
    transformerStorage: TransformerStorage.create(),
...
export const test = {
    ...
    main(assert) {
        ...
        this.add('transformerstorage', function() {
            ...
            // global transformer
            Template.transformerStorage.register('round', function(value) {
                return Math.round(value);
            });
            // specific transformer
            template.transformerStorage.register('uppercase', function(value) {
                return value.toUpperCase();
            });

            assert(Template.transformerStorage.has('round') === true);
            assert(template.transformerStorage.has('round') === true);
            assert(Template.transformerStorage.has('uppercase') === false);
            assert(template.transformerStorage.has('uppercase') === true);

...
var Transformation = CompilableNode.create('transformation', {
    nodeProperties: {
        ...
        populate(compiledSyntaxNode) {
            ...
            // get transformerPrototype from name
            let TransformerPrototype = null;
    ...
    transformerPrototypes: {},

    registerTransformer(TransformerPrototype) {
        this.transformerPrototypes[TransformerPrototype.name] = TransformerPrototype;
    },
    ...
    nodeProperties: {
        ...
        toString() {
            ...
            if (this.transformations.length) {
                string += ' > ';
                string += this.transformations.join(' > ');
            }
            string += '}';
        ...
        transform(input) {
            var output;
            var transformedInput = this.transformation.reduce(function(previousTransformedInput, transformation) {

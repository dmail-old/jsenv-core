...
const CompilableNode = proto.extend('CompilableNode', {
    ...
    populate(syntaxNode) {
        ...
        this.children.forEach(function(nodeChild) {
    ...
    compile(syntaxNodeOrInput) {
        ...
        var compiledSyntaxNode = this.compileSyntaxNode(syntaxNode);

        if (compiledSyntaxNode.children.length) {
        ...
        if (this.instancied) {
            return this.populate(compiledSyntaxNode);
        }

...
(function(global) {
    function emitUnhandledOnBrowser(value, promise) {
        ...
        if (window.onunhandledrejection) {
            ...
            console.log('possibly unhandled rejection "' + value);
        }
    }
    ...
    function emitUnhandledOnNode(value, promise) {
        if (process.listeners('unhandledRejection').length === 0) {
            ...
            console.log('possibly unhandled rejection "' + mess);
        }
    ...
    var emitUnhandled = isBrowser ? emitUnhandledOnBrowser : emitUnhandledOnNode;
    var emitHandled = isBrowser ? emitHandledOnBrowser : emitHandledOnNode;

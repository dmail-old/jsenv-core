...
import AutoRequestHeader from '../middleware/auto-request-header.js';
import Middleware from '../middleware/middleware.js';

var AuthorizationMiddleware = Middleware.extend('AuthorizationMiddleware', {
    useAuthorizationWithTokenRequestHeader(tokenStore) {
        // this strategy consist into setting a token akxop55-ocijdoi authorization header
    }
});

export {AuthorizationMiddleware};

// it's a bit more complicated because you may have several authorization headerValue strategy
// and even other strategy as cookie get params etc
var AuthorizationAutoRequestHeader = AutoRequestHeader.create('authorization', function() {
...
export {AuthorizationAutoRequestHeader};
...
githubAPI.defineRoute('repos/{user}/{repo}/contents/{path}', {
    documentation: 'https://developer.github.com/v3/repos/contents',
    services: [AuthorizationAutoRequestHeader],
    params: {
        user: {
            required: true,
            type: 'string'

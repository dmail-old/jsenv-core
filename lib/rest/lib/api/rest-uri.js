...
const RestURI = rest.extend('RestURI', {
    ...
    constructor(uri, options = {}) {
        ...
        this.options = objectAPI.concat(this.options, options);
    },
    ...
    createRequest(uri, options) {
        ...
        var requestOptions;
        if (options) {
            requestOptions = objectAPI.concat(apiOptions, options);
        } else {
    ...
    defineRoute(routePath, routeDefinition) {
        var routeOptions = objectAPI.concat(this.options, routeDefinition);

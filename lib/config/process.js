        ...
        install() {
            ...
            System.translate = function(load) {
                return translate.call(this, load).then(function(source) {
                    ...
                    if (coverage.urlIsPartOfCoverage(loadUrl)) {
...
engine.config(function configCoverage() {
    ...
    engine.coverage.install().then(function(coverage) {
        return engine.coverage.collect(coverage);
    }).then(function(collector) {
        engine.coverage.report(collector);
    });
}); // .skip('not yet');

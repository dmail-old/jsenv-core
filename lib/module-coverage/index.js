    ...
    install(options) {
        ...
        System.translate = function(load) {
            return translate.call(this, load).then(function(transpiledSource) {
                ...
                let source = sources.get(load.name);
                let loadURL = source ? source.url : load.name;
                ...
                if (options.urlIsPartOfCoverage(loadURL)) {
                    ...
                    try {
                        ...
                        return instrumenter.instrumentSync(transpiledSource, relativeUrl);
                    } catch (e) {

                ...
                if (self.options.urlIsPartOfCoverage(loadURL)) {
                    ...
                    try {
                        ...
                        instrumenter.opts.codeGenerationOptions = {
                            sourceMap: relativeUrl, // il faut passer le fichier d'origine, sauf que ce fichier n'est pas dispo sur le fs puisque transpiled
                        ...
                        var instrumentedSource = instrumenter.instrumentSync(transpiledSource, relativeUrl);
                        ...
                        var base64SourceMap = new Buffer(JSON.stringify(instrumentedSourceMap)).toString('base64');
                        // btoa(unescape(encodeURIComponent(sourceMap)));

                        instrumentedSource += '\n//# sourceURL=' + load.address + '!instrumented';
                        instrumentedSource += '\n//# sourceMappingURL=data:application/json;base64,' + base64SourceMap;

                        env.storeSource(load.address + '!instrumented', instrumentedSource);

...
const Trait = CompilableNode.extend('Trait', {
    ...
    constructor() {
        ...
        this.filterStorage = this.filterStorage.create();
    },
    ...
    populate(syntaxNode) {
        ...
        this.filter = this.filterStorage.generateByName(syntaxNode.value, ...args);
...
export const test = {
    ...
    main(assert) {
        ...
        this.add('a filter may belong to a specifi trait only', function() {
            ...
            let ageBelowFilter = trait.filterStorage.register({
                name: 'age-below',
            ...
            assert(Trait.filterStorage.has('age-below') === false);
            assert(trait.filterStorage.get('age-below') === ageBelowFilter);

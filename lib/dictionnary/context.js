...
const Context = CompilableNode.extend({
    ...
    filterPrototypeStorage: Trait.filterPrototypeStorage,
    ...
    constructor() {
        ...
        this.childPrototype = this.childPrototype.extend({
            filterPrototypeStorage: this.filterPrototypeStorage
        });
    },
...
export const test = {
    ...
    main(assert) {
        this.add('Context', function() {
            var genderFilter = Context.filterPrototypeStorage.register('gender', function(input, value) {
                return input.gender === value;
            });
            var youngFilter = Context.filterPrototypeStorage.register('age-below', function(input, value) {

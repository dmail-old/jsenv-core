...
const Context = CompilableNode.extend({
    ...
    constructor() {
        ...
        this.filterStorage = FilterStorage.create();
...
export const test = {
    ...
    main(assert) {
        this.add('Context', function() {
            var genderFilter = Context.filterStorage.register('gender', function(input, value) {
                return input.gender === value;
            });
            var youngFilter = Context.filterStorage.register('age-below', function(input, value) {

...
Entry.registerCompiler({
    compile(syntaxNode) {
        ...
        var definitionObject = value[firstKey];

        syntaxNode.name = firstKey;
        // syntaxNode.value = null;

        Object.keys(definitionObject).forEach(function(key) {
            let definitionSyntaxNode = syntaxNode.next();

            definitionSyntaxNode.value = {
                [key]: definitionObject[key]
            };
        });
...
export {Context, Definition, Entry, Dictionnary};

...
const DictionnaryEntry = CompilableNode.extend('DictionnaryEntry', {
    name: null,
    definitions: [],
    dictionnary: null,
...
const Dictionnary = CompilableNode.extend('Dictionnary', {
    name: null,
    entries: [],
...
export {Context, Definition, DictionnaryEntry, Dictionnary};

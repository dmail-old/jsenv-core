...
const Constant = templateExports.Constant;
...
const DictionnaryEntry = proto.extend('DictionnaryEntry', {
    name: null,
    definitions: [],
    dictionnary: null,
    ...
    best(input) {
        let bestMatch = this.definitions.sort(this.options.createDefinitionComparer()).find(function(definition) {
            return definition.match(input);
        });
...
const Dictionnary = proto.extend('Dictionnary', {
    name: null,
    entries: [],
    ...
    getDefinition(entryName, input = undefined) {
...
export {ReferencableVariable, Context, Definition, DictionnaryEntry, Dictionnary};

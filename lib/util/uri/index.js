...
import '../../polyfill/url-search-params/index.js#?jsenv|default.needs.url-search-params';
...
let URI = proto.extend('URI', {
    ...
    constructor(data, base) {
        ...
        if (typeof data === 'string') {
            data = jsenv.cleanPath(data);
        }
        if (typeof base === 'string') {
            base = jsenv.cleanPath(base);
        }
...
// helpers properties
var abstractionProperties = (function() {
    ...
    Object.keys(abstractions).forEach(function(abstractionName) {
        ...
        Object.defineProperty(properties, abstractionName, {
            configurable: true,
            enumerable: true,
...
URI.define(abstractionProperties);

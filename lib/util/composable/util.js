...
var proto = {
    ...
    reconstruct(constructor) {
        ...
        return this.refine({constructor: combinedConstructor});
    },
    ...
    use(Component, ...args) {
        ...
        this.refine(Component); // define Component properties
        const component = Component.compile(...args);
        this.refine(component); // define compiled component properties

...
export const test = {
    ...
    main() {
        this.add('object combination', function() {
            ...
            console.log(damElement.value);
            // const sebElement = Lab.scan(seb);
            // const hybridElement = damElement.compose(sebElement);

            // assert.deepEqual(damElement.value, dam);
            // assert.deepEqual(sebElement.value, seb);
            // assert.deepEqual(hybridElement.value, expectedHybrid);
        });

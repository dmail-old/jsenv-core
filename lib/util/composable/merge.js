...

{
    ...
    'object': {
        'same': 'mergeProperties',
        // other case must throw (cannot merge object & array or function for instance)
    },
    'objectProperty': {
        'same': 'mergeProperty',
        // other case must throw (cannot merge objectProperty with sthing else)
    },
    'functionObject': {
        'same: 'replace',
        'different': 'replace'
    ...
    'arrayObject': {
        ...
        // other case must throw (cannot merge array with sthing else than array & object)
        // (we are missing a concat deep, I mean a concat with deep cloning or concatened entries)
    }
}
*/

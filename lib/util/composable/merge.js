...
import {Element, PrimitiveElement, ObjectElement, ObjectPropertyElement} from './tree.js';
...
const FunctionElement = null;
const FunctionElementFragment = FunctionElement.extend({
...
function composeFunction(firstFunction, secondFunction, compositionHandler) {
    ...
    const functionFragment = FunctionElementFragment.create();

    if (compositionHandler) {
        FunctionElementFragment.compile = function() {
...
Element.refine({
    ...
    merge(element) {
        ...
        const mergedElement = elementResponsibleToResolve.resolver.resolveLater(
            elementResponsibleToResolve,
            conflictualElement
        );

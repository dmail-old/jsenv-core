...
import api from 'env/object-clone';

function createOptions(defaultOptions, userOptions) {
    return new api.Factory(defaultOptions || {}, {mergeValue: userOptions || null, arrayConcat: true}).generate();
}
...
let Options = {
    ...
    create(defaultOptions, userOptions) {

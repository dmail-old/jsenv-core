    ...
    var ValueDefinition = createConstructor({
        ...
        constructor(value, parent) {
            ...
            if (arguments.length > 0) {
                ...
                var reference = this.getReference(value);
                if (reference) {
                ...
                if (this.isPrimitive === false && this.isReference === false) {
                    ...
                    propertyNames.forEach(function(propertyName) {
                        ...
                        if (propertyDescriptor === null) {
                            ...
                            propertyValueDefinition = new this.constructor(propertyValue, this);
                        } else {
        ...
        collectPreviousValueDefinitions() {
            ...
            if (this.parent) {
                valueDefinitions.push(this.parent);

                for (var propertyDefinition of this.parent.propertyDefinitions) {
                    var valueDefinition = propertyDefinition.valueDefinition;
                    if (valueDefinition) {
                        valueDefinitions.push(valueDefinition);
                        // valueDefinitions.push(...valueDefinition.collectPreviousValueDefinitions());
                    }
                }
            }
        ...
        getReference(value) {
            ...
            var reference = this.collectPreviousValueDefinitions().find(
                function(valueDefinition) {
                    console.log('check if', valueDefinition.value, '===', value);
        ...
        concat(valueDefinition) {
            ...
            if (valueDefinition.isPrimitive === false) {
                // ok donc y a t-il des références et comment gère-t-on ces putain des références dans le cas d'un concat
                // on ne ptu pas juste les ignorer?
...
export const test = {
    ...
    main(assert) {
        ...
        this.add('definition references', function() {
            ...
            console.log(definition.getPropertyDefinition('2').valueDefinition.isReference);

            // assert(definition.references.length === 1);
            // assert(definition.getPropertyDefinition('0').valueDefinition.referenceOf === definition);
        });
        ...
        //     a.push(a, b, a);
        //     b.push(b, a, b);
        //     var definition = createDefinition(b);

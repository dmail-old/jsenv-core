...
var ValueDefinition = (function() {
    ...
    var ValueDefinition = createConstructor({
        ...
        populateReference() {
            var seenDefinition = this.findReference(this.value);
            // console.log('seach a reference to', this.value, 'got', seenDefinition);
        ...
        clonePropertyDefinition(propertyDefinition) {
            ...
            if (propertyValueDefinition) {
                ...
                var reference = clonedPropertyValueDefinition.findReference(this.value);
                if (reference) {
...
export const test = {
    ...
    main(assert) {
        ...
        this.add('concatened definition references', function() {
            ...
            console.log(fooValueDefinition);

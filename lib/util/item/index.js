    ...
    var ValueDefinition = createConstructor({
        ...
        constructor(value) {
            ...
            if (arguments.length > 0) {
                ...
                if (this.isPrimitive === false && typeof value === 'function') {
        ...
        concat(valueDefinition) {
            ...
            if (valueDefinition.isPrimitive) {
                ...
                concatenedDefinition.value = this.isPrimitive ? valueDefinition.value : this.value;
...
var ValueGenerator = createConstructor({
    ...
    generate() {
        ...
        if (valueDefinition.isPrimitive) {
            ...
            value = this.createValue(valueDefinition.value);

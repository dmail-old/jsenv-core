    ...
    var ValueGenerator = {
        ...
        defineProperty(valuePropertyName, generatedValuePropertyName, mergeValuePropertyNames) {
            ...
            if (generatedValuePropertyDescriptorMustHaveValue &&
                this.options.canSpread(generatedValuePropertyValue, generatedValuePropertyValueOwner)) {
        ...
        constructor(value, options) {
            ...
            if (canSpreadOptionValue === 'auto') {
                if (this.options.arrayConcat === true) {
                    this.options.canSpread = function(value, owner) {
                        return isArray(owner) === false;
                    };
                } else {

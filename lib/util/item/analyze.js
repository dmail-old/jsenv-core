        ...
        if (this.referenceMark) {
            ...
            if (reference) {
                ...
                if (this.primitiveMark) {
                    ...
                    // au lieu de merger une à une on boucle sur les deux en même temps
                    // let propertyDefinitionToMerge;
                    // let selfPropertyDefinition;
                    // let currentValueDefinition = this;
                    // let toBeMerged = [];
                    // let toBeAdded = [];
                    // let i = 0;
                    // let j = valueDefinition.propertyDefinitions.length;
                    // while (i < j) {
                    //     propertyDefinitionToMerge = valueDefinition.propertyDefinitions[i];
                    //     selfPropertyDefinition = currentValueDefinition.findPropertyDefinition(propertyDefinitionToMerge.name);

                    //     if (selfPropertyDefinition) {
                    //         toBeMerged.push(selfPropertyDefinition, mergePropertyDefinition);
                    //     } else {
                    //         toBeAdded.push(propertyDefinitionToMerge);
                    //     }

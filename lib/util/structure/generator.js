...
because constructor will not be called
*/
...
(function() {
    ...
    let PrototypeGenerator = util.extendConstructor(DefinitionGenerator, {
        ...
        defineProperties(value, definition) {
            for (let property of definition.properties) {
                ...
                if (
                    property.hasOwnProperty('definition') &&
                    property.definition.hasOwnProperty('value') &&
    ...
    let functionGenerator = new PrototypeGenerator(Function.prototype, function(definition, mode = 'primitive') {

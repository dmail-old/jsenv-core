...
/*
Now to be able to define how elemeent are composed we prepare a Composant object
an Element may define many Composant that will contain their own logic of how the element is composed
...
const Constituent = util.extend({
    constructor(element) {
        ...
        if (this.elementShortcut) {
            element[this.elementShortcut] = this;
        }
...
// this object is responsible to handle the list of composant of an element
const Composition = util.extend({
    ...
    add(Constituent) {
        if (this.pure) {
            ...
            this.constituents.push(Constituent.create(this.element));
        }
    },
...
export const test = {
    ...
    main(assert) {
        ...
        this.add('multiple link iteration', function() {
            ...
            const multipleLink = multipleElementLink.create();
            element.addChild(elementA);
            element.addChild(multipleLink);

...
Talent.refine({
    link(...args) {
        ...
        const installer = this.createInstaller(...args);
        installer.install();
        return installer;
    },

    createInstaller(subject, ...args) {
        // the properties of the subject object
        ...
        // now we can list differences between sharedProperties & subjectProperties
        // to be able to revert changes
        const diffProperties = sharedProperties.diff(subjectProperties);

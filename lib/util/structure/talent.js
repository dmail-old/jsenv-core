...
const Resolution = (function() {
    ...
    const DefaultResolutionStrategy = PropertyResolutionStrategy.extend({
        ...
        resolve(property, conflictualProperty) {
            // in fact it cannot happen anymore because of the new behaviour ?
...
Property.refine({
    resolveConflict(conflictualProperty) {
        ...
        if (selfStrategyName === 'default' && otherStrategyName === 'default') {
            throw this.createConflictError(
                conflictualProperty,
                'conflict must be handled for property named "' + this.name + '"',
                'resolve(\'remove\')'
            );
        } else if (
        ...
        } else if (selfStrategyName === 'default') {
            // apply the strategy of conflictualProperty
            propertyResponsibleToResolve = conflictualProperty;
        } else if (otherStrategyName === 'default') {
            // apply the strategy of property

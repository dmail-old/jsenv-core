...
export const test = {
    ...
    main(assert) {
        ...
        this.add('Talent.compose', function() {
            ...
            // then with prototyep + instance + link
            // check the composition is ok
            // after that try to create some conflict between composed talent instance properties
            // and see how the error can explain this concept
            // also test conflict of resolution conflict
        });

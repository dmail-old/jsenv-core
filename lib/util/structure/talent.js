...
const Talent = util.extend({
    constructor(definition) {
        ...
        const staticProperties = installProperties(this, StaticProperties);
        staticProperties.collect(this, this);

        const prototypeStaticProperty = staticProperties.get('prototype');
        if (prototypeStaticProperty) {
            prototypeStaticProperty.define(this);
        }
        const prototypeProperties = installProperties(this, PrototypeProperties);
        prototypeProperties.collect(this, this);

        const instanceStaticProperty = staticProperties.get('instance');
        if (instanceStaticProperty) {
            instanceStaticProperty.define(this);
        }
...
Talent.define({
    link(subject, ...args) {
        ...
        this.static.link(linkedTalent);
        linkedTalent.prototype = this.prototype;
        linkedTalent.instance = this.instance;

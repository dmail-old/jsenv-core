        ...
        if (conflictResolution.hasOwnProperty(propertyName)) {
            ...
            if (resolvedProperty.resolutionStrategy.name === 'rename') {
                ...
                if (conflictualProperty) {
                    var message = 'conflict must not be handled by renaming "' + property.name + '" -> "' + renamedWith;
    ...
    compose(...talents) {
        ...
        try {
            ...
            if (e.name === 'PropertyError') {
                ...
                talentCompositionError.actualText = e.message;
                talentCompositionError.hint = 'You can resolve conflict using';

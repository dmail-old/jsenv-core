...
const Variable = CompilableNode.extend({
    name: 'variable',
    childPrototype: Transformation.extend(), // do not ever modify object directly
    chars: {
        transform: '>',
        escape: '\\'
    },
...
export const test = {
    ...
    main(assert) {
        ...
        //     variable.transformerStorage.register('uppercase', function(value) {
        //         return value.toUpperCase();
        //     });
        //     variable.compile('name > uppercase');

        //     let output = variable.eval({name: 'dam'});

        //     assert(output === 'DAM');

        //     assert(Variable.transformerStorage.has('uppercase') === false);
        // });
    }
};
